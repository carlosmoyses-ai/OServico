...
namespace OServico.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdVenda,DataVenda,Cliente,Vendedor")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVenda,DataVenda,Cliente,Vendedor")] Venda venda)
        {
            if (id != venda.IdVenda)
            {
                return NotFound();
