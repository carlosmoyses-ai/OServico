...
namespace OServico.Controllers
{
    public class ServicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ServicoId,Nome,Preco,Descricao")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServicoId,Nome,Preco,Descricao")] Servico servico)
        {
